...
Looking at a large scale system, we should always step back and ask "What are we optimizing this system for?". In the case of mass incarceration and the prison industrial complex, we are optimizing to shut disproportionately large numbers of people of people behind bars, with few rights or supports to allow them to succeed after release, all while large corporations profit from cheap labour and increasing numbers of private prisons.
