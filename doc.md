...
* todo - should include history of  Clinton (welfare changes)?

The number of people incarcerated for drug offenses has risen an astonishing amount since the beginning of the War on Drugs in the 1980s. Drug arrests have tripled since 1980 and more than 31 million people have been incarerated since the War on Drugs began.  <sup>[7](#myfootnote5)</sup>  The War on Drugs was marketed as a way reduce the number of large distributors.  However, this is not the case and the vast majority of arrests are for possession, not distribution.  This increase in the number of prisoners has also led to a huge increase in the number of prisons built.   How did this happen?
...
Per profit prisons require new prisons to be built to allow their profits to grow.  These corporations profits depend on more arrests, and longer sentences upon conviction.  Also, with their primary incentive is their own profit, not reducing the recidisvism rate through educational or vocational training programs.  They are optimized to extract as much profit as possiblefrom taxpapers for their services, while there are few incentives to improve the living conditions of prisoners, or to reduce the chance they will return to prison.
