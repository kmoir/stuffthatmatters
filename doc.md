...
* todo - should include history of  Clinton (welfare changes)?, Crime Omnibus bill
...
* other topics if space
* children plea plea out in most cases
* most cases never go to trial in exchange for leniency
* prosecutors have enormous power, can dismiss a case or add additional charges p 86-87
* mandatory minimums, three strikes have encouraged people to plead out to avoid harsh sentences
* some of these sentences are longer than those for violent crimes
* effects of being labelled a felon p 94
* 68% of people that are released are rearrested with a new offense p94 (much of this is due to economic factors i.e. not finding a job)
* 1/3 of prison re-admittance is due to parole violations p95

Justice is not colourblind. The use and sale of illegal drugs is done at remarkably consistent rates across races.  However, there are stark differences in  the rate at which people are labelled a felon or sent to prison.  The number of black Americans incarcerated for drug crimes has increased more than twenty six times from 1983 to 2000, twenty two times for Latinx groups, and eight times for whites. pg 98 Despite this, Human Rights watch reports that this same year, white youth are much more likely to sell or possess illegal drugs.  In addition, white youth visit the emergency room for drug related visits at a rate of three times those of their black counterparts. p 99 However, the image portrayed by the media is that drug use and sale an affliction of communities of colour, despite concrete evidence to the contrary. 
The numbers large numbers of people of colour labelled a felon, or subsequently imprisioned is a result of racial bias. Racial bias when conducting stop and frisk, and traffic stops.  Racial bias in the the justice system.  For instance, statistical analysis of sentencing in Georgia demonstrated that blacks where 4.3 times more likely to receive the death sentence for a murder conviction that whites that were found guilty of the same crime. p110 There is also discrimation in jury selection, it is easy for prosecutors to select all white juries. p 120t

p 133 racial profiling in policing  as well as whites more likely to carry contraband in cars
